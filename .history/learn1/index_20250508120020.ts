...
/ hero function
function hero(name: string, age: number, isEnabled: boolean): void {
  console.log(`Name: ${name}, Age: ${age}, Enabled: ${isEnabled}`);
}
const heroName: string = "Superman";
const heroAge: number = 30;
const heroIsEnabled: boolean = true;
    hero(heroName, heroAge, heroIsEnabled);
    // hero function with return typefunction heroWithReturn(                    